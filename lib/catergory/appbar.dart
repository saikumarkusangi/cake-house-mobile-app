                            ...
                            child: badge.Badge(
                              ...
                              badgeContent: Consumer<CartController>(
                                builder: (context, value, child) {
                                  return  Text(value.counter.toString(),style:const TextStyle(color: Colors.red),);
                                },
                              ),
                              
                              badgeColor: Colors.white,
                              animationDuration:const Duration(milliseconds: 300),
                             child:const Icon( Icons.card_travel,color: Colors.white,size: 35,),
                            ),
                          ),
                                ),
          ),
              ...
              SliverList(
                ...
                delegate: SliverChildBuilderDelegate((context, index) {
                  ...
                  (_controller.index == 0 && productProvider.products[index].caterory!.trim()  =='pastri' ||
                   ...
                   ||_controller.index == 2 && productProvider.products[index].caterory!.trim()  =='partykit' ||
                   _controller.index == 3 && productProvider.products[index].caterory!.trim()  =='drinks' ||
                   _controller.index == 4 && productProvider.products[index].caterory!.trim()  =='chocolates' || 
                   _controller.index == 5 && productProvider.products[index].caterory!.trim()  =='icecream' || 
                   _controller.index == 6 && productProvider.products[index].caterory!.trim()  =='pizza' || 
                   _controller.index == 7 && productProvider.products[index].caterory!.trim()  =='burger' 
                           ...
                           ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                content: Text('Already added to Bag'),
                                 ...
                                 try {
                                   ...
                                   images_url.add(productProvider.products[index].image);
